...
class BillBuilderService extends Component {
    ...
    componentDidMount() {
        let addButtons = [
            <td style={{textAlign:'right'}}><Fade in={this.state.fadeIn} tag="h5" className="mt-3">
                <button type="button" className={classes.deleteButton} onClick={() => this.deleteServiceButtonClick(this.props.service)}>
                    <img
            ...
            <td style={{textAlign:'right'}}><Fade in={this.state.fadeIn} tag="h5" className="mt-3">
                <button type="button" className={classes.addButton} onClick={() => this.addServiceButtonClick(this.props.service)}><img
